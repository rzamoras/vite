<template>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="fixed w-full  z-20 top-0 left-0 border-b border-gray-200  navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <router-link to="/" class="navbar-brand font-weight-bold text-secondary" style="font-size: 50px;">
