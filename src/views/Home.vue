    ...
    <div class="container-fluid pt-5">
        <div class="container pb-3">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Sponsors</span></p>
                <h1 class="mb-4">Thanks to our top sponsors</h1>
            </div>
            <div class="row">
